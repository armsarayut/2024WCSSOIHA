...
{
    public class PaM64BRptPdf : PdfPageEvents
    {
        //-----------------------------

        #region Attributes
        readonly string reportCaption = "5.4.2.Order picking summary - Report";
        ...
        /// <returns></returns>
        public byte[] ExportPDF(List<Class6_4_B> ListRpt)
        {
        ...
        /// <returns></returns>
        private void ReportBody(Document document, List<Class6_4_B> ListRpts)
        {
            BaseFont baseFont = BaseFontForHeaderFooter;
