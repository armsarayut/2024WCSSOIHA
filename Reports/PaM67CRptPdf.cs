...
{
    public class PaM67CRptPdf : PdfPageEvents
    {
        //-----------------------------
        ...
        /// <returns></returns>
        public byte[] ExportPDF(List<Class6_7_C> ListRpt)
        {
        ...
        /// <returns></returns>
        private void ReportBody(Document document, List<Class6_7_C> ListRpts)
        {
            BaseFont baseFont = BaseFontForHeaderFooter;
