...
{
    public class MasItemPageRptPdf : PdfPageEvents
    {
        //-----------------------------

        #region Attributes
        readonly string reportCaption = "6.1.Item - Report";
        ...
        /// <returns></returns>
        public byte[] ExportPDF(List<Mas_Item_Go> ListRpt)
        {
        ...
        /// <returns></returns>
        private void ReportBody(Document document, List<Mas_Item_Go> ListRpts)
        {
            BaseFont baseFont = BaseFontForHeaderFooter;
