...
{
    public class IbpGRNRprPdf : PdfPageEvents
    {
        //-----------------------------

        #region Attributes
        readonly string reportCaption = "1.1.Receiving Order - Report";
        ...
        /// <returns></returns>
        public byte[] ExportPDF(List<Inb_Goodreceipt_Go> ListRpt)
        {
        ...
        /// <returns></returns>
        private void ReportBody(Document document, List<Inb_Goodreceipt_Go> ListRpts)
        {
            BaseFont baseFont = BaseFontForHeaderFooter;
            ...
            cell = new PdfPCell(new Phrase("DNDate", _fontstyeheader))
            {
                HorizontalAlignment = Element.ALIGN_LEFT,
            ...
            cell = new PdfPCell(new Phrase("Unit", _fontstyeheader))
            {
                HorizontalAlignment = Element.ALIGN_LEFT,
                VerticalAlignment = Element.ALIGN_MIDDLE,
                BackgroundColor = headerBackcolor,
            ...
            cell = new PdfPCell(new Phrase("LotNo", _fontstyeheader))
            {
                HorizontalAlignment = Element.ALIGN_LEFT,
                VerticalAlignment = Element.ALIGN_MIDDLE,
                BackgroundColor = headerBackcolor,
            ...
            cell = new PdfPCell(new Phrase("BatchNo", _fontstyeheader))
            {
                HorizontalAlignment = Element.ALIGN_LEFT,
                VerticalAlignment = Element.ALIGN_MIDDLE,
                BackgroundColor = headerBackcolor,
            ...
            {
                cell = new PdfPCell(new Phrase(Convert.ToDateTime(listRpt.Docdate).ToString(VarGlobals.FormatD), _fontstyebody))
                {
                    HorizontalAlignment = Element.ALIGN_LEFT,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                ...
                cell = new PdfPCell(new Phrase(string.Format(VarGlobals.FormatN2, listRpt.DisQuantity).ToString(), _fontstyebody))
                {
                    HorizontalAlignment = Element.ALIGN_LEFT,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    BackgroundColor = bodyBackcolor,
                ...
                cell = new PdfPCell(new Phrase(listRpt.Unit.ToString(), _fontstyebody))
                {
                    HorizontalAlignment = Element.ALIGN_LEFT,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    BackgroundColor = bodyBackcolor,
                ...
                cell = new PdfPCell(new Phrase(listRpt.Docnote.ToString(), _fontstyebody))
                {
