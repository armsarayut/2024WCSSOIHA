...
{
    public class PaM67BRptPdf : PdfPageEvents
    {
        //-----------------------------

        #region Attributes
        readonly string reportCaption = "5.5.3.ASRS-Inbound/hour - Report";
        ...
        /// <returns></returns>
        public byte[] ExportPDF(List<Class6_7_B> ListRpt)
        {
            PaM67BRptPdf pdfReport = new PaM67BRptPdf();
            Document document;
            if (bPageLanscape)
            {
        ...
        /// <returns></returns>
        private void ReportBody(Document document, List<Class6_7_B> ListRpts)
        {
            BaseFont baseFont = BaseFontForHeaderFooter;
            ...
            cell = new PdfPCell(new Phrase("STROAGEBIN", _fontstyeheader))
            {
                HorizontalAlignment = Element.ALIGN_LEFT,
                VerticalAlignment = Element.ALIGN_MIDDLE,
                BackgroundColor = headerBackcolor,
            ...
            foreach (var listRpt in ListRpts)
            {
                ...
                cell = new PdfPCell(new Phrase(listRpt.Loc_No.ToString(), _fontstyebody))
                {
                    HorizontalAlignment = Element.ALIGN_LEFT,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    BackgroundColor = bodyBackcolor,
