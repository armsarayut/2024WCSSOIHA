...
{
    public class MasterUsersRptPdf : PdfPageEvents
    {
        //-----------------------------

        #region Attributes
        readonly string reportCaption = "7.2.User - Report";
        ...
        /// <returns></returns>
        public byte[] ExportPDF(List<Userinfo> ListRpt)
        {
        ...
        /// <returns></returns>
        private void ReportBody(Document document, List<Userinfo> ListRpts)
        {
            BaseFont baseFont = BaseFontForHeaderFooter;
            ...
            cell = new PdfPCell(new Phrase("USERID", _fontstyeheader))
            {
                HorizontalAlignment = Element.ALIGN_LEFT,
                VerticalAlignment = Element.ALIGN_MIDDLE,
                BackgroundColor = headerBackcolor,
            ...
            cell = new PdfPCell(new Phrase("USERNAME", _fontstyeheader))
            {
                HorizontalAlignment = Element.ALIGN_LEFT,
                VerticalAlignment = Element.ALIGN_MIDDLE,
                BackgroundColor = headerBackcolor,
            ...
            foreach (var listRpt in ListRpts)
            {
                ...
                cell = new PdfPCell(new Phrase(listRpt.Usgrp.ToString(), _fontstyebody))
                {
                    HorizontalAlignment = Element.ALIGN_LEFT,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                ...
                cell = new PdfPCell(new Phrase(listRpt.UserId.ToString(), _fontstyebody))
                {
                    HorizontalAlignment = Element.ALIGN_LEFT,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    BackgroundColor = bodyBackcolor,
                ...
                cell = new PdfPCell(new Phrase(listRpt.Usname.ToString(), _fontstyebody))
                {
                    HorizontalAlignment = Element.ALIGN_LEFT,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    BackgroundColor = bodyBackcolor,
