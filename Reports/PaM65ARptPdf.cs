...
{
    public class PaM65ARptPdf : PdfPageEvents
    {
        //-----------------------------

        #region Attributes
        readonly string reportCaption = "5.5.1.ASRS-History - Report";
        ...
        /// <returns></returns>
        public byte[] ExportPDF(List<Class6_5_A> ListRpt)
        {
        ...
        /// <returns></returns>
        private void ReportBody(Document document, List<Class6_5_A> ListRpts)
        {
            BaseFont baseFont = BaseFontForHeaderFooter;
            ...
            cell = new PdfPCell(new Phrase("CREATED", _fontstyeheader))
            {
                HorizontalAlignment = Element.ALIGN_LEFT,
            ...
            foreach (var listRpt in ListRpts)
            {
                ...
                cell = new PdfPCell(new Phrase(listRpt.Status.ToString(), _fontstyebody))
                {
                    HorizontalAlignment = Element.ALIGN_LEFT,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    BackgroundColor = bodyBackcolor,
