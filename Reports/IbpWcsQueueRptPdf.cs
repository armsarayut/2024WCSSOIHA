...
{
    public class IbpWcsQueueRptPdf : PdfPageEvents
    {
        //-----------------------------

        #region Attributes
        readonly string reportCaption = "1.3.Master Queuing - Report";
        ...
        /// <returns></returns>
        public byte[] ExportPDF(List<Inb_Putaway_Go> ListRpt)
        {
        ...
        /// <returns></returns>
        private void ReportBody(Document document, List<Inb_Putaway_Go> ListRpts)
        {
            BaseFont baseFont = BaseFontForHeaderFooter;
            ...
            cell = new PdfPCell(new Phrase("Queuetime", _fontstyeheader))
            {
                HorizontalAlignment = Element.ALIGN_LEFT,
            ...
            foreach (var listRpt in ListRpts)
            {
                ...
                cell = new PdfPCell(new Phrase(listRpt.Puttype.ToString(), _fontstyebody))
                {
                    HorizontalAlignment = Element.ALIGN_LEFT,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    BackgroundColor = bodyBackcolor,
