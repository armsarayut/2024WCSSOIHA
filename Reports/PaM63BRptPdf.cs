...
{
    public class PaM63BRptPdf : PdfPageEvents
    {
        //-----------------------------

        #region Attributes
        readonly string reportCaption = "5.3.2.Inventory summary - Report";
        ...
        /// <returns></returns>
        public byte[] ExportPDF(List<Class6_3_B> ListRpt)
        {
        ...
        /// <returns></returns>
        private void ReportBody(Document document, List<Class6_3_B> ListRpts)
        {
            BaseFont baseFont = BaseFontForHeaderFooter;
            ...
            foreach (var listRpt in ListRpts)
            {
                ...
                cell = new PdfPCell(new Phrase(string.Format(VarGlobals.FormatN3, listRpt.Totalstock), _fontstyebody))
                {
                    HorizontalAlignment = Element.ALIGN_LEFT,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    BackgroundColor = bodyBackcolor,
